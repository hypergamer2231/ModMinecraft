...
public class ExplosiveRevolverItem extends SmgWorldModElements.ModElement {
	@ObjectHolder("smg_world:explosive_revolver")
	public static final Item block = null;
	@ObjectHolder("smg_world:entitybulletexplosive_revolver")
	public static final EntityType arrow = null;
	public ExplosiveRevolverItem(SmgWorldModElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletexplosive_revolver").setRegistryName("entitybulletexplosive_revolver"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("explosive_revolver");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(ExplosiveRevolverBulletItem.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(ExplosiveRevolverBulletItem.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(ExplosiveRevolverBulletItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(ExplosiveRevolverBulletItem.block, (int) (1));
		}
