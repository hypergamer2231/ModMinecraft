...
package minecraft.smg.world.block;
...
public class GlowlyBlock extends SmgWorldModElements.ModElement {
	@ObjectHolder("smg_world:glowly")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("smg_world:glowly_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public GlowlyBlock(SmgWorldModElements instance) {
		super(instance, 13);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("smg_world:blocks/sandy_portal_frame"), new ResourceLocation("smg_world:blocks/sandy_portal_frame"))
				.luminosity(0).density(1000).viscosity(1000)).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("glowly");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("glowly_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER)) {
		}.setRegistryName("glowly"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("glowly_bucket"));
	}
